...
-- Dieses Skript erweitert die Supabaseâ€‘Datenbank um benÃ¶tigte Spalten, Tabellen
-- und Rowâ€‘Levelâ€‘Securityâ€‘Policies fÃ¼r die neue Roommateâ€‘Version. Es ist
-- idempotent â€“ eine erneute AusfÃ¼hrung fÃ¼hrt zu keinem Fehler.

-- === Spaltenâ€‘Erweiterungen in existing tables ===
...
-- === Neue Tabelle fÃ¼r hochgeladene Bilder ===
...
-- === Policies fÃ¼r gegenstand_details ===
...
-- Ã–ffentlich lesbar: listing-images
